...
var _imgbox = new Imgbox_1.default();
var getImagesList = function (list) { return __awaiter(void 0, void 0, void 0, function () {
    var result, _i, list_1, image, response, buffer, filename, filename;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                image = list_1[_i];
                return [4 /*yield*/, axios_1.default.get(image, {
            ...
            case 2:
                ...
                try {
                    filename = response.headers['content-disposition']
                        .split('filename="')[1]
                        .split('"')[0];
                    result.push({ buffer: buffer, filename: filename });
                }
                catch (error) {
